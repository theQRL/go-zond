...
// Tests disassembling the instructions for valid zvm code
...
// Tests disassembling the instructions for invalid zvm code
...
// Tests disassembling the instructions for empty zvm code
