...
func TestDAOForkRangeExtradata(t *testing.T) {
	...
	proBc, _ := NewBlockChain(proDb, nil, progspec, ethash.NewFaker(), vm.Config{}, nil, nil)
	defer proBc.Stop()
	...
	conBc, _ := NewBlockChain(conDb, nil, congspec, ethash.NewFaker(), vm.Config{}, nil, nil)
	defer conBc.Stop()
	...
	for i := int64(0); i < params.DAOForkExtraRange.Int64(); i++ {
		...
		bc, _ := NewBlockChain(rawdb.NewMemoryDatabase(), nil, congspec, ethash.NewFaker(), vm.Config{}, nil, nil)
		...
		bc, _ = NewBlockChain(rawdb.NewMemoryDatabase(), nil, progspec, ethash.NewFaker(), vm.Config{}, nil, nil)
