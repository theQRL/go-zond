...
// ReplyPooledTransactionsRLP is the zond/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeadersRLP is the zond/66 response to GetBlockHeaders.
...
// ReplyBlockBodiesRLP is the zond/66 response to GetBlockBodies.
