...
// information related to the Zond protocol such as blocks, transactions and logs.
...
// `zond_getFilterChanges` polling method that is also used for log filters.
