...
var (
	...
	BetaNetGenesisHash = common.HexToHash("0x8fac1530eab2f997dee99115a2eb983b3da39924d96961e17c78388fcb449990")
...
var (
	...
	// BetaNetChainConfig contains the chain parameters to run a node on the Sepolia test network.
	BetaNetChainConfig = &ChainConfig{
		...
		TerminalTotalDifficultyPassed: true,
		ShanghaiTime:                  newUint64(1691355800),
		Ethash:                        new(EthashConfig),
	}
	...
	SepoliaChainConfig = &ChainConfig{
		...
		ShanghaiTime:                  newUint64(1691232400),
		Ethash:                        new(EthashConfig),
	}
