...
func (db *Database) ReadAncients(fn func(op zonddb.AncientReaderOp) error) (err error) {
	return fn(db)
}
...
func (db *Database) ModifyAncients(f func(zonddb.AncientWriteOp) error) (int64, error) {
	panic("not supported")
}
...
func New(client *rpc.Client) zonddb.Database {
	return &Database{
		remote: client,
	}
}
