...
var (
	ErrLocked  = pqaccounts.NewAuthNeededError("password or unlock")
...
func (ks *KeyStore) SignHash(a accounts.Account, hash []byte) ([]byte, error) {
	...
	//return crypto.Sign(hash, unlockedKey.DilithiumKey)
	return nil, nil
}
...
func (ks *KeyStore) SignTx(a accounts.Account, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	//return types.SignTx(tx, signer, unlockedKey.DilithiumKey)
	return nil, nil
}
...
func (ks *KeyStore) SignHashWithPassphrase(a accounts.Account, passphrase string, hash []byte) (signature []byte, err error) {
	...
	//}
	////TODO: (cyyber)
	////defer zeroKey(key.DilithiumKey)
	////TODO: (cyyber)
	//return crypto.Sign(hash, key.DilithiumKey)
	return nil, nil
}
...
func (ks *KeyStore) SignTxWithPassphrase(a accounts.Account, passphrase string, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	//signer := types.LatestSignerForChainID(chainID)
	//return types.SignTx(tx, signer, key.DilithiumKey)
	return nil, nil
}
...
func (ks *KeyStore) Import(keyJSON []byte, passphrase, newPassphrase string) (accounts.Account, error) {
	...
	if key != nil && key.DilithiumKey != nil {
		//TODO: (cyyber) look into zeroKey
		//defer zeroKey(key.DilithiumKey)
	}
	if err != nil {
		return accounts.Account{}, err
